...
function App() {
    ...
    const isLaptopView = useMediaQuery({minWidth:1440, maxWidth:1920})
    const isDesktopView = useMediaQuery({minWidth:1920})
    // const props = {allTasks, ...dashboardHomeStudentMobileData}
    return (
        <>
            {isMobileView &&  <TasksStudentMobile {...{allTasks, ...tasksStudentMobileData}} />}
            {isTabletView && <TasksStudentTablet {...{allTasks, ...tasksStudentTabletData}}/>}
