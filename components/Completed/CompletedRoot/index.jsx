...
export default function CompletedRoot() {
  ...
  return (
    <ReactiveRender
      mobile={
        <CompletedMobile {...{tasks, ...completedMobileData}} />
      }
      tablet={
        <CompletedTablet {...{tasks,...completedTabletData}} />
      }
      laptop={
        <CompletedLaptop {...{tasks,...completedLaptopData}} />
      }
      desktop={
        <CompletedDesktop {...{tasks,...completedDesktopData}} />
      }
    />
  );
}
