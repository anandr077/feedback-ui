...
function Content4(props) {
  const { assignmentTitle, classTitle } = props;
  return (
    <Content>
      <PhysicsThermodyna>{assignmentTitle}</PhysicsThermodyna>
      <FundamentalsOfThermalPhysics>{classTitle}</FundamentalsOfThermalPhysics>
    </Content>
  );
}
