...
import { AddButton, AddButtonContainer, AddButtonImage, AddButtonText, ButtonsContainer, CancelAndContinueButtonsContainer, CancelButtonContainer, CancelButtonText, CancelIcon, DeleteIcon, Image, ImageContainer, ImagesContainer, OrderPagesContainer, OrderPagesMainContainer, StyledImage, StyledInput } from './style';
            ...
            >
              <ImagesContainer>
                {selectedImages.map((image) => (
                  <DraggableImage key={image.id} id={image.id} image={image} onClickFn={() => DeleteImage(image.id)} />
                ))}
              </ImagesContainer>
            </SortableContext>
          </OrderPagesContainer>
