...
import ReviewsFrame136632 from "../ReviewsFrame136632";
...
import CommentCard22 from "../CommentCard22";
...
import "./FeedbackTeacherTablet.css";

function FeedbackTeacherTablet(props) {
  const {
    frame1349,
    frame5,
    physicsThermodyna,
  ...
  return (
    <div className="feedback-teacher-tablet screen">
      <Frame1388>
        <Frame1387>
          <Frame1350>
        ...
        <Frame1386>
          <Frame1371>
            ...
            <Frame1369>
              ...
              <ReviewsFrame131722
                buttonsProps={frame131721Props.buttonsProps}
                buttons2Props={frame131721Props.buttons2Props}
              />
            </Frame1369>
          </Frame1371>
          <Frame1368>
                ...
                <Frame1366>
                  ...
                  <Group1308>
                    <OverlapGroup>
                      ...
                      <Rectangle5481></Rectangle5481>
                    </OverlapGroup>
                  </Group1308>
                </Frame1366>
                <Line26 src={line261} alt="Line 26" />
                <ReviewsFrame136632 q2PoremIpsumDolo={frame136631Props.q2PoremIpsumDolo} />
                <Line26 src={line262} alt="Line 26" />
                <ReviewsFrame136632 q2PoremIpsumDolo={frame136632Props.q2PoremIpsumDolo} />
              </Frame1367>
            </Group1225>
            <Frame1331>
              <Frame1322>
              ...
              <Frame1328>
                <CommentCard22 horemIpsumDolorSi={commentCard21Props.horemIpsumDolorSi} />
                <CommentCard22 horemIpsumDolorSi={commentCard22Props.horemIpsumDolorSi} />
                <CommentCard22
                  horemIpsumDolorSi={commentCard23Props.horemIpsumDolorSi}
                  className={commentCard23Props.className}
                />
                <CommentCard22
                  horemIpsumDolorSi={commentCard24Props.horemIpsumDolorSi}
                  className={commentCard24Props.className}
                />
              </Frame1328>
            </Frame1331>
          </Frame1368>
          <Frame1370>
            <ReviewsFrame1316 />
            <ReviewsFrame131722 buttonsProps={frame131722Props.buttonsProps} buttons2Props={frame131722Props.buttons2Props} />
          </Frame1370>
        </Frame1386>
      </Frame1388>
      <Frame1380>
...
const Rectangle5481 = styled.div`
  position: absolute;
  width: 393px;
  height: 26px;
  top: 50px;
...
export default FeedbackTeacherTablet;
